    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('transactions.selectType') }}" class="btn btn-primary">
            ...
            <div class="card-body">
                ...
                @else
                    <div class="alert alert-info">
                        Tidak ada transaksi ditemukan. <a href="{{ route('transactions.selectType') }}">Tambahkan transaksi pertama Anda</a>.
                    </div>
                @endif
            </div>
        </div>
